...
func (_mock *MockProducer) SendMessage(ctx context.Context, msg kafka.Message) error {
...
//   - ctx context.Context
//   - msg kafka.Message
func (_e *MockProducer_Expecter) SendMessage(ctx any, msg any) *MockProducer_SendMessage_Call {
...
func (_c *MockProducer_SendMessage_Call) Return(err error) *MockProducer_SendMessage_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockProducer_SendMessage_Call) RunAndReturn(run func(ctx context.Context, msg kafka.Message) error) *MockProducer_SendMessage_Call {
	_c.Call.Return(run)
	return _c
}
